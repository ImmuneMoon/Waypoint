...
- All visible play map content: shapes, images, text items without `gmNoteFor`, token names and `charStats` tooltips, `room.image` scene art and character `portrait`s (shown in hover tooltips of linked items).
