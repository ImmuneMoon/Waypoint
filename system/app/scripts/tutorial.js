...
function tutorialHud() {
    return { title: 'Combat HUD', tabs: [{ id: 't_tut_hact', label: 'Actions', icon: 'icon:dice' }, { id: 't_tut_hstat', label: 'Status', icon: 'icon:heart-pulse' }], band: [{ id: 'f_tut_hp' }, { id: 'f_tut_ac' }, { id: 'f_tut_prone' }],
        sections: [{ id: 's_tut_hchk', title: 'Checks', tab: 't_tut_hact', cols: 1, inline: true, fields: [{ id: 'f_tut_str', w: 1 }, { id: 'f_tut_sword', w: 1 }, { roll: 'r_tut_atk', w: 1 }] }, { id: 's_tut_hfx', title: 'Condition', tab: 't_tut_hstat', cols: 1, fields: [{ id: 'f_tut_hp', w: 1 }, { id: 'f_tut_fx', w: 'row' }] }] };
}
...
function buildTutorialCampaign() {
    ...
    camp.tutorialSeed = 1;   // HUD frame (HF4a): the seed migrations this build already carries (ensureTutorialSheet runs each once, on an older tutorial)
