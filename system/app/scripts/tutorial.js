...
var STEPS = [
    ...
    { target: '#plannerTools', title: 'Writing a planner',
      html: 'Add blocks from the toolbar: headings, prose, callouts, titled tables and flowcharts. The <b>&#8617; &#8618;</b> buttons are this planner\'s own <b>undo and redo</b> — a deleted block, row or node comes back where it was; inside a text field <kbd>Ctrl</kbd>+<kbd>Z</kbd> first takes back your typing, then reaches the same history. <b>Render</b> shows the finished page; <b>Export As</b> turns it into an image, PDF or HTML. The <b>&#127912;</b> button sets a font and colors for this page, or a look for the whole campaign (Handbook pages and sheets follow it too).',
      before: function() { openItem('plan_tut_session1'); } },
