...
var STEPS = [
    ...
    { target: '#wbFloatingToolbar', title: 'Play map tools',
      html: 'Now inside the cave, on its Play Map. Left to right: centre, undo, grid and snap, then the tools — move, pan, draw, erase, <b>measure</b> (rulers) and <b>blast</b> (a grenade radius with per-token distances), then text, shapes, images and the picture library, and <b>Import Character</b> for a shadow-base.com sheet.',
