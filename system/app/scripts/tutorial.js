...
var STEPS = [
    ...
    { target: '#campaignSelect', title: 'Campaigns',
      html: 'Everything belongs to a campaign. This picker switches between them; the buttons beside it add, rename, search and delete campaigns. Your own campaigns are untouched by the tutorial. The <b>Waypoint</b> logo (top-left) opens the <b>Welcome</b> screen &mdash; start, import, continue or join a campaign, and set your profile (name, colour, picture); choose when it appears in <b>Settings &#9656; Profile</b>.' },
    ...
    { target: '#fxBtn', title: 'Visual effects',
      html: 'Under the &#127916; <b>Scene</b> button too. Flashes, screen shake, colour washes, bursts on the map, weather and banners &mdash; the &#10024; panel fires them and the players on that map (and the stream window) see them. Pick a burst look then click the map; a token can <b>Pulse</b> from its right-click menu; <b>Sound with it</b> fires a cue alongside. Off for the campaign, or <b>Reduce motion</b> for yourself, in &#9881; Settings &#9656; VTT features. A VTT feature, per campaign.',
