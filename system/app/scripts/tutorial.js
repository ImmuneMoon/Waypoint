...
var STEPS = [
    ...
    { target: '#sheetPanel', title: 'A character sheet',
      html: 'Bren&rsquo;s sheet, over the play map. Characters live in the editor&rsquo;s <b>Characters</b> tab and any token can point at one (right-click a token &#9656; <b>Sheet&hellip;</b>): numbers and skills with their totals, HP as a bar with &minus; and +, conditions, notes &mdash; the <b>header block</b> under the name says who Bren is (Fighter, his abilities, STR modifier, Sight) and the <b>band</b> keeps HP, AC, Prone and Initiative in reach on every tab &mdash; and the roll buttons roll at the table with the sheet&rsquo;s values. A player opens their own the same way and edits what you left editable; fields marked <b>Hover</b> show on the hover card and in the party strip. Bren&rsquo;s <b>Kit</b> holds a <b>Firepot</b> with a &#128165; <b>Throw</b> &mdash; press it, then click the map.',
