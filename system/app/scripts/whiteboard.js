...
function castLibraryHtml(filter) {
    ...
    return '<div class="img-lib-folder cast-head" style="color:var(--gold);"><span>&#9733; Campaign Cast</span><span class="cast-head-note" title="A click on a face places one copy at the centre of your view; its \u00d7 button drops the number set in Copies">\u2014 click a face to place one, \u00d7 for a batch</span><label class="cast-batch-wrap" title="How many copies the \u00d7 button on a cell drops (1\u201350)">Copies <input type="number" class="cast-batch" min="1" max="50" value="' + castBatch() + '"></label></div>'
