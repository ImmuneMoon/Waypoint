          ...
          if(!el) {
              ...
              el.addEventListener('pointerenter', function(e) {
                  ...
                  if(wItem.isChar) {
                      ...
                      if (!isClientC && wItem.gmInfo) { var ttGm = document.createElement('div'); ttGm.className = 'rc'; ttGm.style.cssText = 'color:var(--gold); font-size:11px; white-space:pre-wrap; margin-top:4px; border-top:1px solid var(--edge); padding-top:3px;'; ttGm.textContent = wItem.gmInfo; ttRoot.appendChild(ttGm); }   // per-token GM note / dialogue (GM only; stripped on the wire)
